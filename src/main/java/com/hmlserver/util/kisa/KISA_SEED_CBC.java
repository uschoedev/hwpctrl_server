package com.hmlserver.util.kisa;
...
public class KISA_SEED_CBC {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(KISA_SEED_CBC.class);
    ...
    private static final int EndianChange(int dwS) {
        return (((((dwS) << (8)) | (((dwS) >> (32 - (8))) & 0x000000ff)) & 0x00ff00ff)
